...
sys.path.append('/shared/pso/step_1x_choose_tiles_large')
from choose_tiles_camels import choose
sys.path.append('/shared/pso/step_2x_env_covariates')
from get_env_covariates import get_covariates

def main():
    # where are we?
    base_dir = '/shared/pso/step_6x_extrapolate'
    ...
    # where are we going to save the pixels gdf?
